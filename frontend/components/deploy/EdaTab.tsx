...
export default function EdaTab({ numericStats, getHistogramData, primary, accent, inputs, scatterTarget, getScatterDataWithTrend, rawRows }: any) {
  return (
    <div className="p-5 bg-white rounded-xl border border-zinc-100 shadow-sm space-y-6 animate-in fade-in zoom-in-95">
      <div className="space-y-4">
        <div className="flex justify-between items-end border-b border-zinc-100 pb-2">
          ...
          <span className="text-[9px] font-bold text-zinc-400">Calculated from {rawRows.length} rows</span>
        </div>
