          ...
          <aside className="hidden lg:flex w-64 flex-col bg-white/60 backdrop-blur-2xl border-r border-zinc-200/50 fixed inset-y-0 left-0 z-50">
            ...
            <div className="p-4">
              <div className="p-3 rounded-2xl bg-white border border-zinc-200 shadow-sm flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-emerald-100 flex items-center justify-center text-[10px] font-black text-emerald-700">AQ</div>
                <div className="overflow-hidden">
                  <p className="text-[13px] font-black text-zinc-900 truncate">Alqurtubi</p>
                  <p className="text-[9px] text-emerald-600 font-bold uppercase tracking-widest">Pro Engineer</p>
                </div>
              </div>
            </div>
          </aside>
